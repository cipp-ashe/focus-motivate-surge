 ...
 */
export const getTaskTypeDefinition = (type: TaskType = 'regular'): TaskTypeDefinition => {
 ...
 */
export const getTaskIcon = (type: TaskType = 'regular'): React.ReactNode => {
 ...
 */
export const getTaskLabel = (type: TaskType = 'regular'): string => {
