  ...
  return (
    <div className="min-h-screen py-8 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-[10%] w-[50vw] h-[50vw] max-w-[800px] max-h-[800px] bg-primary/10 rounded-full filter blur-[100px] opacity-70 animate-float"></div>
        <div className="absolute bottom-[10%] right-[10%] w-[40vw] h-[40vw] max-w-[700px] max-h-[700px] bg-purple-500/10 rounded-full filter blur-[100px] opacity-50" style={{ animationDelay: '2s', animationDuration: '8s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-16 md:mb-24">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="rounded-full px-8 border-primary/20 bg-card hover:bg-primary/10">
                <Link to="/habits">
          ...
          <div className="bg-gradient-to-br from-amber-50/90 via-amber-50/40 to-transparent dark:from-amber-950/30 dark:via-amber-950/10 dark:to-transparent border border-amber-100/50 dark:border-amber-800/30 rounded-xl overflow-hidden shadow-xl mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white/80 dark:bg-black/20 backdrop-blur-md rounded-lg border border-amber-200/50 dark:border-amber-800/30 p-5 shadow-md transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="pl-12 border-l-2 border-blue-200 dark:border-blue-800/50 ml-4">
                    ...
                    <p className="text-sm text-muted-foreground">Auto-creates a timed task with proper tags</p>
                  </div>
                </div>
                ...
                <div className="bg-white/80 dark:bg-black/20 backdrop-blur-md rounded-lg border border-green-200/50 dark:border-green-800/30 p-5 shadow-md transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="pl-12 border-l-2 border-green-200 dark:border-green-800/50 ml-4">
                    ...
                    <p className="text-sm text-muted-foreground">Auto-generates a journal entry with prompts</p>
                  </div>
                </div>
              </div>
              
              <div className="text-center">
                <Button asChild variant="default" size="lg" className="bg-amber-500 hover:bg-amber-600 rounded-full">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Tasks Card */}
            <Card className="border-primary/10 bg-gradient-to-br from-blue-50/50 to-transparent dark:from-blue-950/20 dark:to-transparent shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <CardHeader>
                <div className="bg-primary/10 w-12 h-12 rounded-full flex items-center justify-center mb-3">
                  <ListTodo className="h-6 w-6 text-primary" />
                </div>
                <CardTitle>Task Management</CardTitle>
                <CardDescription>Organize all your work in one place</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {/* Timer Card */}
            <Card className="border-primary/10 bg-gradient-to-br from-purple-50/50 to-transparent dark:from-purple-950/20 dark:to-transparent shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle>Focus Timers</CardTitle>
              ...
              <CardFooter>
                <Button asChild className="w-full" variant="default" style={{ backgroundColor: "#9b87f5", borderColor: "#9b87f5" }}>
            ...
            {/* Notes Card */}
            <Card className="border-primary/10 bg-gradient-to-br from-green-50/50 to-transparent dark:from-green-950/20 dark:to-transparent shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <CardHeader>
                <div className="bg-green-400/10 w-12 h-12 rounded-full flex items-center justify-center mb-3">
                  <BookOpen className="h-6 w-6 text-green-500" />
                </div>
                <CardTitle>Notes & Journals</CardTitle>
                <CardDescription>Capture ideas and reflections</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center gap-2">
              ...
              <CardFooter>
                <Button asChild className="w-full" variant="default" style={{ backgroundColor: "rgb(74, 222, 128)", borderColor: "rgb(74, 222, 128)" }}>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 md:gap-4">
            <Link to="/tasks" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-primary/5">
            ...
            <Link to="/timer" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-[#9b87f5]/5">
            ...
            <Link to="/habits" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-amber-400/5">
            ...
            <Link to="/screenshots" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-blue-400/5">
            ...
            <Link to="/notes" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-green-400/5">
            ...
            <Link to="/voice-notes" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-rose-400/5">
            ...
            <Link to="/tasks" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-cyan-400/5">
            ...
            <Link to="/settings" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/80 dark:bg-black/20 border border-gray-100 dark:border-gray-800/50 shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:bg-gray-400/5">
        ...
        {/* Privacy Section */}
        <section className="mb-16">
          <div className="bg-gradient-to-r from-gray-50 to-transparent dark:from-gray-900/30 dark:to-transparent border border-gray-100 dark:border-gray-800/30 rounded-xl p-6 shadow-lg">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-muted-foreground mb-4">
                  TaskTimer saves your data to your browser's local storage. For access across multiple devices, 
