...
const Index = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mb-6">
        <div className="glass-card p-4 md:p-5 bg-gradient-to-r from-gray-50 to-transparent dark:from-gray-900/30 dark:to-transparent border border-gray-100 dark:border-gray-800/30 transition-all duration-300 hover:shadow-md">
