...
export const useTimerInitialization = ({
  ...
  // Set up timer monitoring - use the return value correctly
  ...
  // Handle auto-complete function - store the returned function directly
  ...
  return {
    ...
    // Auto-complete - return the function directly
    autoComplete
  };
};
