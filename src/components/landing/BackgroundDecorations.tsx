...
const BackgroundDecorations: React.FC = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[40%] right-[20%] w-64 h-64 bg-violet-400/10 rounded-full filter blur-3xl opacity-25 animate-float-top" style={{ animationDelay: '1s' }}></div>
      
      {/* Additional soft glows with increased opacity for better visibility */}
      <div className="absolute top-[30%] left-[20%] w-96 h-96 bg-primary/10 rounded-full filter blur-3xl opacity-30 animate-float-top" style={{ animationDelay: '3s' }}></div>
      <div className="absolute bottom-[40%] left-[5%] w-64 h-64 bg-accent/10 rounded-full filter blur-3xl opacity-25 animate-float-right" style={{ animationDelay: '2.5s' }}></div>
    </div>
  );
};
