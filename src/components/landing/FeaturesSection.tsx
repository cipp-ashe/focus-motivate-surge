    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <FeatureCard 
          ...
          buttonStyle={{ backgroundColor: "#9b87f5", borderColor: "#9b87f5" }}
        />
        ...
        <FeatureCard 
          ...
          buttonStyle={{ backgroundColor: "rgb(74, 222, 128)", borderColor: "rgb(74, 222, 128)" }}
        />
      </div>
    </section>
  );
...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <Card className={`border-primary/10 bg-gradient-to-br ${cardClass} to-transparent shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 backdrop-blur-sm`}>
      <CardHeader>
        <div className={`${iconBgClass} w-12 h-12 rounded-full flex items-center justify-center mb-3`}>
