...
export const TaskLayout = ({ mainContent, asideContent }: TaskLayoutProps) => {
  ...
  if (isMobile) {
    return (
      <div className="min-h-screen w-full py-2 px-2 transition-colors duration-300 bg-[#1A1F2C] overflow-hidden">
  ...
  return (
    <div className="min-h-screen w-full py-8 px-4 sm:px-6 transition-colors duration-300 bg-[#1A1F2C] overflow-hidden">
